"""
Funções utilitárias para configuração de logging no projeto.
Permite criar loggers que salvam em arquivo e/ou exibem no console.
"""
import logging
...
def create_logger(
    ...
    """
    Configura e retorna um logger básico para o projeto.
